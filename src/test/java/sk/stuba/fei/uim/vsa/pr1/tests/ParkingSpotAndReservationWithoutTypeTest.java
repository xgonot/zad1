 ...
 * @author sheax
 */
public class ParkingSpotAndReservationWithoutTypeTest {
    ...
    @Test
    public void SPOT_RES_01_getAvailableSpotsTest() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException
    {
    ...
    @Test
    public void SPOT_RES_02_getOccupiedParkingSpotsWithoutTypeTest() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException
    {
                Object carPark = carParkService.createCarPark("test7", "testtest", 12);
        assertNotNull(carPark);
